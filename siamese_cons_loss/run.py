...
def main():
    ...
    # 构建数据集
    # dataset_loader = PhasePairLoader([r'D:\实验数据\2021\siamese_cons_loss\train_tfrecord\train.tfrecord'],
    #                                  [r'D:\实验数据\2021\siamese_cons_loss\test_tfrecord\test.tfrecord'],
...
def test():
    ...
    plot_model(resnet, to_file="resnet34.png", show_shapes=True)
