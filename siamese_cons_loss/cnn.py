...
def cons_cnn_model_2(input_shape):
    cnn_model = Sequential(name='5_layer_CNN')
    cnn_model.add(Conv2D(8,
                         kernel_size=(2, 8),
                         strides=(1, 2),
    ...
    cnn_model.add(BatchNormalization(name='BN_3'))
    cnn_model.add(ReLU(name='Relu_3'))
    cnn_model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='MP_3'))
    ...
    cnn_model.add(BatchNormalization(name='BN_4'))
    cnn_model.add(ReLU(name='Relu_4'))
    cnn_model.add(MaxPooling2D(pool_size=(3, 3), strides=(3, 3), padding='same', name='MP_4'))
    ...
    cnn_model.add(layers.GlobalAvgPool2D())
